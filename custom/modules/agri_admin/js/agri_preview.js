/**
 * @file
 * Preview behaviors. Copy of node/node.preview.js with changes
 * 1. exclude language switch link at
 *      'a:not([href^="#"], .node-preview-container a, .language-link)'
 * 2. fix bug by storing the target href before clicking 'Leave' button
 */
    ...
    detach(context, settings, trigger) {
      if (trigger === 'unload') {
        if (
          ...
          $(document).off('click.agri_preview');
        }
      }
    },
  };
